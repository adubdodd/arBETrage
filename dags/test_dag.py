...
with DAG(
    dag_id='test_soccer_betting_pipeline',
    ...
    def extract_odds(**context):
        df = pd.DataFrame([
            {"Match_ID": "1abcdefg", "League_Title":"Premier League", "League_Key":"soccer_epl", "Start_Time":"2025-05-28 14:15", "Home_Team":"Chelsea FC", "Away_Team":"Manchester United FC", "Bookmaker":"FanDuel", "Home_Odds": 2.10, "Away_Odds": 2.10, "Draw_Odds": 4.00, "Matchup": "Team A vs. Team B"},
            {"Match_ID": "1abcdefg", "League_Title":"Premier League", "League_Key":"soccer_epl", "Start_Time":"2025-05-28 14:15", "Home_Team":"Chelsea FC", "Away_Team":"Manchester United FC", "Bookmaker":"ESPN BET", "Home_Odds": 2.50, "Away_Odds": 2.60, "Draw_Odds": 4.80, "Matchup": "Team C vs. Team D"},
            {"Match_ID": "1abcdefg", "League_Title":"Premier League", "League_Key":"soccer_epl", "Start_Time":"2025-05-28 14:15", "Home_Team":"Chelsea FC", "Away_Team":"Manchester United FC", "Bookmaker":"DraftKings", "Home_Odds": 2.30, "Away_Odds": 2.40, "Draw_Odds": 4.50, "Matchup": "Team E vs. Team F"},
        ])
        logging.info(f"Mock extract: {len(df)} matches")
        context['ti'].xcom_push(key='odds_df', value=df.to_json())
